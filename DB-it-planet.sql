...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1993425657ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=registration&table=visitedlocations">`registration`.`visitedlocations`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=registration&table=animal">`registration`.`animal`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=registration&table=animaltype">`registration`.`animaltype`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=registration&table=Animal">`registration`.`Animal`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=registration&table=account">`registration`.`account`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=registration&table=Account">`registration`.`Account`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cms&table=posts">`cms`.`posts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cms&table=categories">`cms`.`categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cms&table=category">`cms`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=login_app&table=users">`login_app`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  <ul>
    <li class="first new_database italics"><div class='block'><i class='first'></i></div><div class="block second"><a href='index.php?route=/server/databases&server=1'><img src="themes/dot.gif" title="" alt="" class="icon ic_b_newdb"></a></div><a class='hover_show_full' href='index.php?route=/server/databases&server=1' title='New'>New</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h" data-vpath="cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h" data-pos="0"></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=information_schema&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=information_schema' title='Structure'>information_schema</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.bG9naW5fYXBw" data-vpath="cm9vdA==.bG9naW5fYXBw" data-pos="0"></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=login_app&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=login_app' title='Structure'>login_app</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.bXlzcWw=" data-vpath="cm9vdA==.bXlzcWw=" data-pos="0"></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=mysql&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=mysql' title='Structure'>mysql</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cGVyZm9ybWFuY2Vfc2NoZW1h" data-vpath="cm9vdA==.cGVyZm9ybWFuY2Vfc2NoZW1h" data-pos="0"></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=performance_schema&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=performance_schema' title='Structure'>performance_schema</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cGhwbXlhZG1pbg==" data-vpath="cm9vdA==.cGhwbXlhZG1pbg==" data-pos="0"></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=phpmyadmin&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=phpmyadmin' title='Structure'>phpmyadmin</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cmVnaXN0cmF0aW9u" data-vpath="cm9vdA==.cmVnaXN0cmF0aW9u" data-pos="0"></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=registration&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=registration' title='Structure'>registration</a><div class="clearfloat"></div></li><li class="navGroup"><div class='block'><i></i><b></b><a class="expander loaded container" href='#'><span class="hide paths_nav" data-apath="cm9vdA==" data-vpath="cm9vdA==.c3Fs" data-pos="0"></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><i><div class="block second"><u><img src="themes/dot.gif" title="Groups" alt="Groups" class="icon ic_b_group"></u></div>&nbsp;sql</i><div class="clearfloat"></div><div style='display: none;' class='list_container'><ul><li class="database database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.c3FsX2ludm9pY2luZw==" data-vpath="cm9vdA==.c3Fs.aW52b2ljaW5n" data-pos="0"></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=sql_invoicing&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=sql_invoicing' title='Structure'>sql_invoicing</a><div class="clearfloat"></div></li><li class="database last database"><div class='block'><i></i><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.c3FsX3N0b3Jl" data-vpath="cm9vdA==.c3Fs.c3RvcmU=" data-pos="0"></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=sql_store&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=sql_store' title='Structure'>sql_store</a><div class="clearfloat"></div></li></ul></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.dGFza2xpc3Q=" data-vpath="cm9vdA==.dGFza2xpc3Q=" data-pos="0"></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=tasklist&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=tasklist' title='Structure'>tasklist</a><div class="clearfloat"></div></li><li class="last navGroup"><div class='block'><i></i><a class="expander loaded container" href='#'><span class="hide paths_nav" data-apath="cm9vdA==" data-vpath="cm9vdA==.dGVzdA==" data-pos="0"></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><i><div class="block second"><u><img src="themes/dot.gif" title="Groups" alt="Groups" class="icon ic_b_group"></u></div>&nbsp;test</i><div class="clearfloat"></div><div style='display: none;' class='list_container'><ul><li class="database database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.dGVzdA==" data-vpath="cm9vdA==.dGVzdA==." data-pos="0"></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=test&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=test' title='Structure'>test</a><div class="clearfloat"></div></li><li class="database last database"><div class='block'><i></i><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.dGVzdF9kYg==" data-vpath="cm9vdA==.dGVzdA==.ZGI=" data-pos="0"></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=test_db&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=test_db' title='Structure'>test_db</a><div class="clearfloat"></div></li></ul></div></li>
  </ul>
</div>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="695a57597c4c6f3e7b4b4c4d36317e39">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="registration" targettable="account">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `registration`.`account` ( `id` INT(11) NOT NULL AUTO_INCREMENT ,  `firstName` VARCHAR(256) NULL DEFAULT NULL ,  `lastName` VARCHAR(256) NULL DEFAULT NULL ,  `password` VARCHAR(256) NULL DEFAULT NULL ,  `email` VARCHAR(256) NULL DEFAULT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="registration" targettable="animal">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `registration`.`animal` ( `id` INT(11) NOT NULL AUTO_INCREMENT ,  `type` VARCHAR(256) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `animal`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="registration" targettable="animal">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `animal`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="registration" targettable="animaltype">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">
            RENAME TABLE `registration`.`animal`
                  TO `registration`.`animaltype`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="registration" targettable="animaltype">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `animaltype`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="registration" targettable="animaltype">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `registration`.`animal` ( `id` INT(11) NOT NULL AUTO_INCREMENT ,  `animalTypes` LONGTEXT NOT NULL ,  `weight` FLOAT NOT NULL ,  `length` FLOAT NOT NULL ,  `height` FLOAT NOT NULL ,  `gender` TEXT NOT NULL ,  `lifeStatus` INT NOT NULL ,  `chippingDateTime` DATETIME NOT NULL ,  `chipperId` INT NOT NULL ,  `chippingLocationId` LONGTEXT NOT NULL ,  `VisitedLocations` LONGTEXT NOT NULL ,  `deathDateTime` DATETIME NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="registration" targettable="visitedlocations">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `registration`.`visitedlocations` ( `id` INT(11) NOT NULL AUTO_INCREMENT ,  `dateTimeOfVisitLocationPoint` DATETIME NOT NULL ,  `locationPointId` INT NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
